...
import {
  ...
  RestrictionType,
} from "moonlands/dist/types/common";
...
export type ClientEnterPromptChooseNCardsFromZone =
...
export type ClientEnterPromptChooseUpToNCardsFromZone =
  ClientEnterPromptInterface & {
...
export type ClientEnterPromptDistributeEnergyOnCreatures =
  ClientEnterPromptInterface & {
    promptType: typeof PROMPT_TYPE_DISTRIBUTE_ENERGY_ON_CREATURES;
    amount: number;
  };

export type ClientEnterPromptRearrangeEnergyOnCreatures =
  ClientEnterPromptInterface & {
    promptType: typeof PROMPT_TYPE_REARRANGE_ENERGY_ON_CREATURES;
  };

export type ClientEnterPromptRearrangeCardsOfZone =
  ClientEnterPromptInterface & {
...
export type ClientEnterPromptAnyCreatureExceptSource =
  ClientEnterPromptInterface & {
...
export type ClientEnterPromptSingleCreatureFiltered =
  ClientEnterPromptInterface & {
...
export type ClientEnterPromptAction =
...
export type ClientEffectAction =

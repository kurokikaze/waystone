...
export type CardStyleType =
  | typeof CARD_STYLE_NORMAL
  | typeof CARD_STYLE_LOCKET
  | typeof CARD_STYLE_DRAGGABLE;
...
export type ExpandedPromptParams = Omit<
  Omit<Omit<PromptParams, "promptType">, "zoneOwner">,
  "restrictionValue"
> & {
  amount?: number;
  cards?: ConvertedCard[];

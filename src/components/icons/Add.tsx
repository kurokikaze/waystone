...
export default function Add({size = 200, fillColor = '#000'}: IconProps) {
	return (
		<svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" fill={fillColor} width={size} height={size}>

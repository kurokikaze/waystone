...
function DeckContent({deck}) {
	...
	return <div className='deckGrid'>
		...
		<Row>
			<Col span={8}><img className='smaller' src={`/cards/${camelCase(magiOne)}.jpg`} /></Col>
			<Col span={8}><img className='smaller' src={`/cards/${camelCase(magiTwo)}.jpg`} /></Col>
			<Col span={8}><img className='smaller' src={`/cards/${camelCase(magiThree)}.jpg`} /></Col>
		</Row>
		<Row>

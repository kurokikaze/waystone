...
describe("Simulations", () => {
  it("test", () => {
    ...
    const weebo = new CardInGame(
      byName("Weebo") as Card,
      ACTIVE_PLAYER,
    ).addEnergy(1);
    const timberHyren = new CardInGame(
      byName("Timber Hyren") as Card,
      ACTIVE_PLAYER,
    ).addEnergy(6);
    const weebo2 = new CardInGame(
      byName("Weebo") as Card,
      ACTIVE_PLAYER,
    ).addEnergy(1);
    const carillion = new CardInGame(
      byName("Carillion") as Card,
      ACTIVE_PLAYER,
    ).addEnergy(3);
    const lavaBalamant = new CardInGame(
      byName("Lava Balamant") as Card,
      NON_ACTIVE_PLAYER,
    ).addEnergy(5);
    const kelthet = new CardInGame(
      byName("Kelthet") as Card,
      NON_ACTIVE_PLAYER,
    ).addEnergy(4);
    const lavaAq = new CardInGame(
      byName("Lava Aq") as Card,
      NON_ACTIVE_PLAYER,
    ).addEnergy(2);
    const pruitt = new CardInGame(
      byName("Pruitt") as Card,
      ACTIVE_PLAYER,
    ).addEnergy(5);
    const magam = new CardInGame(
      byName("Magam") as Card,
      ACTIVE_PLAYER,
    ).addEnergy(4);
    const zones = createZones(ACTIVE_PLAYER, NON_ACTIVE_PLAYER, [
      weebo,
      timberHyren,
      weebo2,
      carillion,
    ...
    const serializedState = gameState.serializeData(
      ACTIVE_PLAYER,
    ) as SerializedClientState;
  ...
  it("Failed power activation", () => {
    ...
    const stateRepresentation = new GameState(
      stateJson as unknown as SerializedClientState,
    );
    stateRepresentation.setPlayerId(ACTIVE_PLAYER);
...
describe("Strange attacks", () => {
  it("Double attack", () => {
    const serializedState = {
      ...
      zones: {
        ...
        opponentHand: [
          { id: "pSi8m1-JdNkFeW-oa43G_", owner: 1, card: null, data: null },
          { id: "48wjHspTobH_alQwAKFdA", owner: 1, card: null, data: null },
          { id: "5DVEmT4JwiNcIlUKN8D_9", owner: 1, card: null, data: null },
          { id: "HiuX10f5Rt0nC2eV9B8i_", owner: 1, card: null, data: null },
          { id: "v0kP7ro4eBUlmTMsuOKWU", owner: 1, card: null, data: null },
          { id: "vAruVzDnEFdCV3Ze0mUjv", owner: 1, card: null, data: null },
        ],
        playerDeck: [
          { card: null, data: {}, owner: 2, id: "kttlD_gzSFhzJ9VDCkl1C" },
          { card: null, data: {}, owner: 2, id: "dq898gykj9lkykH0CS9Ms" },
          { card: null, data: {}, owner: 2, id: "Rrogbk6VMiJ5zeW8sE1RC" },
          { card: null, data: {}, owner: 2, id: "d56KE8EALzv1_k4-KzScR" },
          { card: null, data: {}, owner: 2, id: "yVJKQCdzadVW_goRiiNX2" },
          { card: null, data: {}, owner: 2, id: "OfiCXAnHPr0d9ChpsCb0n" },
          { card: null, data: {}, owner: 2, id: "hpcWik387uYptUqM2aA2S" },
          { card: null, data: {}, owner: 2, id: "Zs-M5mQMCwTthcgxHNJwj" },
          { card: null, data: {}, owner: 2, id: "n0hGzyAKZyhOmrzhdATDe" },
          { card: null, data: {}, owner: 2, id: "p2TLLIobU2nSzM2C_GrsL" },
          { card: null, data: {}, owner: 2, id: "xaiHpVCM08MrOISB5Bt8s" },
          { card: null, data: {}, owner: 2, id: "n_Fq10krXegLrYDCE6qn8" },
          { card: null, data: {}, owner: 2, id: "sGCPjv9OVQzQ23Ic8kyQX" },
          { card: null, data: {}, owner: 2, id: "I-ZQQOiaZJTf0r3Cz-AUw" },
          { card: null, data: {}, owner: 2, id: "CXdcxLOtKm0EbTQ_5vDk9" },
          { card: null, data: {}, owner: 2, id: "siV4qHWnwG-ERg6YWSIUg" },
          { card: null, data: {}, owner: 2, id: "3yaS5D_qltOlEOfwil2_x" },
          { card: null, data: {}, owner: 2, id: "pKFCg5K78XFL1WyccZ_DR" },
          { card: null, data: {}, owner: 2, id: "Dz51fskXZAbRioK79vBMi" },
          { card: null, data: {}, owner: 2, id: "J1WzkbZ4rwh2dtRuM5xC5" },
          { card: null, data: {}, owner: 2, id: "mXIGjalgCzww-gxvhBP4H" },
          { card: null, data: {}, owner: 2, id: "PZv0ORfp4KOEs6PnFy_zS" },
          { card: null, data: {}, owner: 2, id: "y2qblxEd6X-Xeo2CrZmji" },
          { card: null, data: {}, owner: 2, id: "MK3em6cD_AnzKJSUA3PAn" },
          { card: null, data: {}, owner: 2, id: "L1F4hsHYvmET6-sSU8lxF" },
          { card: null, data: {}, owner: 2, id: "xVsKYnbg3WVTz8geZz0GC" },
          { card: null, data: {}, owner: 2, id: "fi-kwNFOWH1brvXcImwKp" },
          { card: null, data: {}, owner: 2, id: "JdbpwCR0Mnt6_-OdEjnOJ" },
          { card: null, data: {}, owner: 2, id: "PhXhP22ry8IztpoOnxd_v" },
          { card: null, data: {}, owner: 2, id: "_odTQCLqXkLA4ssTGrTfU" },
          { card: null, data: {}, owner: 2, id: "oL2gcveRNoOlQAnf8I4Xu" },
          { card: null, data: {}, owner: 2, id: "KtE1_IkILSwDXBhQ9mdlg" },
        ],
        opponentDeck: [
          { card: null, data: {}, owner: 1, id: "yPfPXVVIGaQiV1XTzKKR-" },
          { card: null, data: {}, owner: 1, id: "SUpJ8F5JWYPJwWsTKsIpX" },
          { card: null, data: {}, owner: 1, id: "kdZDrlHIcYhQDmdzp9ZoM" },
          { card: null, data: {}, owner: 1, id: "Uhpuq0J--nSwxaMjXc31y" },
          { card: null, data: {}, owner: 1, id: "TIu8DZEdkUH_DzujObCRg" },
          { card: null, data: {}, owner: 1, id: "SnfKlSRh3CZFq39ppZ1fL" },
          { card: null, data: {}, owner: 1, id: "hMLvapicRh8zVuXS7nOoi" },
          { card: null, data: {}, owner: 1, id: "SffIerohbYz19ExSgRc1b" },
          { card: null, data: {}, owner: 1, id: "Kal8LNy7h3qUU2QT_4lsD" },
          { card: null, data: {}, owner: 1, id: "Vz7iiktRGPWtZY6Qs9WDB" },
          { card: null, data: {}, owner: 1, id: "J4-C-ktHbu4DjTIoh7L46" },
          { card: null, data: {}, owner: 1, id: "sR8XqCMQr9lfMe938KAl7" },
          { card: null, data: {}, owner: 1, id: "jRt090PLRb-vwUR6wWtSb" },
          { card: null, data: {}, owner: 1, id: "WRNOlB52RzPqA25A2Cr1g" },
          { card: null, data: {}, owner: 1, id: "yQ_fM7_f8H4Bs4mX0HWnK" },
          { card: null, data: {}, owner: 1, id: "4jH9Rb8jTLX0k7QAfEiC3" },
          { card: null, data: {}, owner: 1, id: "XPELhOApYdrncdtRHdzS8" },
          { card: null, data: {}, owner: 1, id: "y7ptNaFIznDejm54Wrw6m" },
          { card: null, data: {}, owner: 1, id: "gVx11ZcaJ7FuS_58vCX9H" },
          { card: null, data: {}, owner: 1, id: "zJN7_OKCoZHNzR_5BNCAJ" },
          { card: null, data: {}, owner: 1, id: "VAcx_a_VBfreTEL2SvThq" },
          { card: null, data: {}, owner: 1, id: "YchQ3Y5_L9dpQ7LxBNUUo" },
          { card: null, data: {}, owner: 1, id: "g_eZxTMbAoTP_MZY2mVoZ" },
          { card: null, data: {}, owner: 1, id: "m2cQ_CDH1HBMKo1sYQ6VU" },
          { card: null, data: {}, owner: 1, id: "WMPc1P_yBhUmvl4lFqPwA" },
          { card: null, data: {}, owner: 1, id: "XHeP3uyaZnaf-02ppBXso" },
          { card: null, data: {}, owner: 1, id: "Un7TvBfg3g4pSC2q3PNhf" },
          { card: null, data: {}, owner: 1, id: "8wsaJJd-jL2BhUiQ2GdW_" },
          { card: null, data: {}, owner: 1, id: "VLbemUDoJtveYI6d_g_jB" },
          { card: null, data: {}, owner: 1, id: "X6VcsW8scQYb37GgUDExw" },
          { card: null, data: {}, owner: 1, id: "6VggEuT-NKx3LQwPhD6S-" },
          { card: null, data: {}, owner: 1, id: "cMZd4ubNUF29YXhnQe0cj" },
          { card: null, data: {}, owner: 1, id: "GOHpVOqTwh52_wNPWpHfu" },
        ],
        playerActiveMagi: [
          {
            id: "uKxaRkuhyTfuU3641VnB3",
            owner: 2,
            card: "Evu",
            data: {
              energy: 8,
        ...
        playerMagiPile: [
          ...
          },
          {
            ...
            owner: 2,
            id: "hTAcPBSoJIUqvbmvK-LxA",
          },
        ],
        opponentMagiPile: [
          { card: null, data: {}, owner: 1, id: "AAlJQZlVEfxFLUIHlOsrp" },
          { card: null, data: {}, owner: 1, id: "MV8dw-zEUZqt8HkQBPLaY" },
        ],
        inPlay: [
          {
            id: "6IVDwepRNbUecQlnBi5XD",
            owner: 2,
            card: "Furok",
            data: {
              energy: 4,
    ...
    const stateRepresentation = new GameState(
      serializedState as unknown as SerializedClientState,
    );

    const FUROK_ID = serializedState.zones.inPlay.find(
      (card) => card.card === "Furok",
    )?.id;
    const PLITH_ID = serializedState.zones.inPlay.find(
      (card) => card.card === "Plith",
    )?.id;
    const STRADUS_ID = serializedState.zones.opponentActiveMagi.find(
      (card) => card.card === "Stradus",
    )?.id;
    const LOVIAN_ID = serializedState.zones.inPlay.find(
      (card) => card.card === "Lovian",
    )?.id;
    ...
    if (
      "source" in actionsOnHold[0].action &&
      "target" in actionsOnHold[0].action
    ) {
    ...
    if (
      "source" in actionsOnHold[1].action &&
      "target" in actionsOnHold[1].action
    ) {
  ...
  it("Attacks into Magi with creature", () => {
    ...
    const cardDeck = (id: string, owner: number) => ({
      id,
      data: {},
      card: null,
      owner,
  ...
  it("Cald vs Naroom", (done) => {
    ...
    const connectorOne = {
      ...
      emit: (type: string, action: any) => {
        ...
        if (type === "clientAction") {
          ...
          if (convertedCommand) {
            if (
              convertedCommand.type === ACTION_PLAY &&
              "payload" in convertedCommand &&
              !convertedCommand.payload.card
            ) {
              console.log(
                `Cannot convert ACTION_PLAY command, source card: ${action.payload.card.name} [${action.payload.card.id}]`,
              );
      ...
      emit: (_type: string, action: any) => {
        ...
        if (convertedCommand) {
          if (
            ...
            console.error(
              `Cannot convert ACTION_PLAY command, source card: ${action.payload.card.card} [${action.payload.card.id}]`,
            );
            console.log(
              game
                .getZone(ZONE_TYPE_HAND, 2)
                .cards.map((card) => `[${card.id}] ${card.card.name}`)
                .join(", "),
            );
            console.dir(action?.payload?.card);
            expect(true).toEqual(false);
    ...
    game.setOnAction((action: AnyEffectType) => {
      ...
      if (action.type === ACTION_PLAYER_WINS) {
        ...
        // console.dir(action)
        const magiLeft =
          game.getZone(ZONE_TYPE_MAGI_PILE, action.player).cards.length + 1; // plus active magi
        const energyLeft = game.getZone(ZONE_TYPE_ACTIVE_MAGI, action.player)
          .card?.data.energy;
        const creaturesLeft = game
          .getZone(ZONE_TYPE_IN_PLAY)
          .cards.filter((card) => card.data.controller == action.player).length;
        console.log(
          `Winning player has ${magiLeft} Magi left with ${energyLeft} energy on active Magi and ${creaturesLeft} creatures`,
        );
          ...
          if (convertedCommand) {
            ...
            try {
              ...
              if (
                e &&
                "message" in e &&
                e.message == "Non-prompt action in the prompt state"
              ) {
                actionCallbackOne({
                  type: "display/status",
                });

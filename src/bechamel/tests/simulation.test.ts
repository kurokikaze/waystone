...
describe('Simulations', () => {
    ...
    it.only('Underneath vs Naroom', (done) => {
        ...
        const connectorOne = {
            ...
            emit: function (type: string, action: any) {
                if (type === 'clientAction') {
                    this.gameLog.push({
                        from: 1,
            ...
            close: function () {
                fs.writeFileSync('./replayPlayerOne.json', JSON.stringify(this.gameLog, null, 2));
                // fs.writeFileSync('./commandsPlayerOne.json', JSON.stringify(this.commands, null, 2));
                // console.log(`Closing the connection`);
            }
        }
        ...
        const connectorTwo = {
            ...
            close: function () {
                ...
                fs.writeFileSync('./commandsPlayerTwo.json', JSON.stringify(this.commands, null, 2));
                // console.log(`Closing the connection`);
            }
        }

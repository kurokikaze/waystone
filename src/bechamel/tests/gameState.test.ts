  ...
  it.only("Strange prompt entering", () => {
    ...
    const log = [
      ...
      },
      {
        ...
        promptParams: {
          availableCards: ["Leaf Hyren", "Balamant Pup", "Vortex of Knowledge"],
      ...
      },
      {
        ...
        promptType: "prompt/choose_cards",
        promptParams: {
          availableCards: ["Fog Bank", "Lovian"],
      ...
      },
      {
        ...
        target: {
          ...
          data: {
            ...
            controller: 2,
            attacked: 0,
            actionsUsed: ["Heroes' Feast", "Heroes' Feast"],
      ...
      },
      {
        ...
        targetCard: {
          ...
          data: {
            ...
            controller: 1,
            attacked: 0,
            actionsUsed: ["Healing Rain", "Healing Rain"],
            energyLostThisTurn: 0,
            defeatedCreature: false,
            hasAttacked: false,
            wasAttacked: false,
      ...
      },
      {
        ...
        source: {
          ...
          data: {
            ...
            controller: 1,
            attacked: 0,
            actionsUsed: ["Shockstorm", "Shockstorm"],
      ...
      },
      {
        ...
        promptParams: {},
        message:
          "Select your creature. Its energy will be moved onto your Magi and the creature will return to your hand.",
        generatedBy: "j8ZIUUnNFs4bEwK3uL4iC",
        player: 1,
      },
      {

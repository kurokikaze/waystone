...
export declare const ACTION_CREATE_CONTINOUS_EFFECT =
  "actions/create_continuous_effect";
...
export declare const PROPERTY_MAGI_STARTING_ENERGY =
  "properties/magi_starting_energy";
...
export declare const PROPERTY_CAN_ATTACK_MAGI_DIRECTLY =
  "properties/can_attack_magi_directly";
export declare const PROPERTY_POWER_COST = "properties/power_cost";
export declare const PROPERTY_ENERGY_LOSS_THRESHOLD =
  "properties/energy_loss_threshold";
export declare const PROPERTY_PROTECTION = "properties/protection";
export declare const PROPERTY_STATUS_DEFEATED_CREATURE =
  "properties/status/defeated_creature";
export declare const PROPERTY_STATUS_WAS_ATTACKED =
  "properties/status/was_attacked";
...
export declare const SELECTOR_CREATURES_OF_PLAYER =
  "selectors/creatures_of_player";
export declare const SELECTOR_MAGI = "selectors/magi";
export declare const SELECTOR_CREATURES_AND_MAGI =
  "selectors/creatures_and_magi";
...
export declare const SELECTOR_CREATURES_OF_REGION =
  "selectors/creatures_of_region";
export declare const SELECTOR_CREATURES_NOT_OF_REGION =
  "selectors/creatures_not_of_region";
export declare const SELECTOR_MAGI_OF_REGION = "selectors/magi_of_region";
export declare const SELECTOR_MAGI_NOT_OF_REGION =
  "selectors/magi_not_of_region";
...
export declare const SELECTOR_OWN_CARDS_WITH_ENERGIZE_RATE =
  "selectors/own_cards_with_energize_rate";
export declare const SELECTOR_CARDS_WITH_ENERGIZE_RATE =
  "selectors/cards_with_energize_rate";
...
export declare const SELECTOR_CREATURES_NOT_OF_TYPE =
  "selectors/creatures_not_of_type";
export declare const SELECTOR_OWN_CREATURES_OF_TYPE =
  "selectors/own_creatures_of_type";
export declare const SELECTOR_OTHER_CREATURES_OF_TYPE =
  "selectors/other_creatures_of_type";
export declare const SELECTOR_RELICS = "selectors/relics";
export declare const SELECTOR_OWN_SPELLS_IN_HAND =
  "selectors/own_spells_in_hand";
export declare const SELECTOR_OWN_CREATURES_WITH_STATUS =
  "selectors/own_creatures_with_status";
export declare const SELECTOR_CREATURES_WITHOUT_STATUS =
  "selectors/creatures_without_status";
export declare const SELECTOR_STATUS = "selectors/status";
export declare const SELECTOR_ID = "selectors/id";
export declare const SELECTOR_OWN_CREATURE_WITH_LEAST_ENERGY =
  "selectors/own_creature_with_least_energy";
...
export declare const CALCULATION_SUBTRACT_TO_MINIMUM_OF_ONE =
  "calculations/subtract_to_minimum_of_one";
export declare const CALCULATION_HALVE_ROUND_DOWN =
  "calculations/halve_round_down";
...
export declare const PROTECTION_TYPE_ENERGY_GAIN =
  "protection/type/energy_gain";
export declare const PROTECTION_TYPE_ENERGY_LOSS =
  "protection/type/energy_loss";
export declare const PROTECTION_TYPE_DISCARDING_FROM_PLAY =
  "protection/type/discarding_from_play";
...
export declare const EFFECT_TYPE_RESHUFFLE_DISCARD =
  "effects/reshuffle_discard";
export declare const EFFECT_TYPE_DISCARD_RESHUFFLED =
  "effects/discard_reshuffled";
...
export declare const EFFECT_TYPE_ATTACKER_DEALS_DAMAGE =
  "effects/attacker_deals_damage";
export declare const EFFECT_TYPE_DEFENDER_DEALS_DAMAGE =
  "effects/defender_deals_damage";
...
export declare const EFFECT_TYPE_CREATURE_DEFEATS_CREATURE =
  "effects/creature_defeats_creature";
export declare const EFFECT_TYPE_CREATURE_IS_DEFEATED =
  "effects/creature_is_defeated";
...
export declare const EFFECT_TYPE_CREATURE_ENTERS_PLAY =
  "effects/creature_enters_play";
export declare const EFFECT_TYPE_RELIC_ENTERS_PLAY =
  "effects/relic_enters_play";
export declare const EFFECT_TYPE_PAYING_ENERGY_FOR_RELIC =
  "effects/paying_energy_for_relic";
export declare const EFFECT_TYPE_PAYING_ENERGY_FOR_SPELL =
  "effects/paying_energy_for_spell";
export declare const EFFECT_TYPE_PAYING_ENERGY_FOR_CREATURE =
  "effects/paying_energy_for_creature";
export declare const EFFECT_TYPE_STARTING_ENERGY_ON_CREATURE =
  "effects/starting_energy_on_creature";
export declare const EFFECT_TYPE_MOVE_CARD_BETWEEN_ZONES =
  "effects/move_card_between_zones";
export declare const EFFECT_TYPE_MOVE_CARDS_BETWEEN_ZONES =
  "effects/move_cards_between_zones";
export declare const EFFECT_TYPE_CARD_MOVED_BETWEEN_ZONES =
  "effects/card_moved_between_zones";
export declare const EFFECT_TYPE_CONDITIONAL = "effects/conditional";
export declare const EFFECT_TYPE_ADD_ENERGY_TO_CREATURE_OR_MAGI =
  "effects/add_energy_to_creature_or_magi";
export declare const EFFECT_TYPE_ADD_ENERGY_TO_CREATURE =
  "effects/add_energy_to_creature";
export declare const EFFECT_TYPE_ADD_ENERGY_TO_MAGI =
  "effects/add_energy_to_magi";
export declare const EFFECT_TYPE_ADD_STARTING_ENERGY_TO_MAGI =
  "effects/add_starting_energy_to_magi";
...
export declare const EFFECT_TYPE_RETURN_CREATURE_DISCARDING_ENERGY =
  "effects/return_creature_discarding_energy";
export declare const EFFECT_TYPE_RETURN_CREATURE_RETURNING_ENERGY =
  "effects/return_creature_returning_energy";
export declare const EFFECT_TYPE_DISCARD_ENERGY_FROM_CREATURE =
  "effects/discard_energy_from_creature";
export declare const EFFECT_TYPE_REMOVE_ENERGY_FROM_CREATURE =
  "effects/remove_energy_from_creature";
export declare const EFFECT_TYPE_DISCARD_ENERGY_FROM_CREATURES =
  "effects/discard_energy_from_creatures";
export declare const EFFECT_TYPE_DISCARD_ENERGY_FROM_MAGI =
  "effects/discard_energy_from_magi";
export declare const EFFECT_TYPE_REMOVE_ENERGY_FROM_MAGI =
  "effects/remove_energy_from_magi";
export declare const EFFECT_TYPE_DISCARD_CREATURE_FROM_PLAY =
  "effects/discard_creature_from_play";
export declare const EFFECT_TYPE_DISCARD_CREATURE_OR_RELIC =
  "effects/discard_creature_or_relic";
export declare const EFFECT_TYPE_DISCARD_ENERGY_FROM_CREATURE_OR_MAGI =
  "effects/discard_energy_from_creature_or_magi";
export declare const EFFECT_TYPE_RESTORE_CREATURE_TO_STARTING_ENERGY =
  "effects/restore_creature_to_starting_energy";
export declare const EFFECT_TYPE_PAYING_ENERGY_FOR_POWER =
  "effects/paying_energy_for_power";
export declare const EFFECT_TYPE_DISCARD_RELIC_FROM_PLAY =
  "effects/discard_relic_from_play";
export declare const EFFECT_TYPE_CREATURE_ATTACKS = "effects/creature_attacks";
export declare const EFFECT_TYPE_CREATURE_IS_ATTACKED =
  "effects/creature_is_attacked";
export declare const EFFECT_TYPE_BEFORE_DRAWING_CARDS_IN_DRAW_STEP =
  "effects/before_drawing_cards_in_draw_step";
export declare const EFFECT_TYPE_DRAW_CARDS_IN_DRAW_STEP =
  "effects/draw_cards_in_draw_step";
...
export declare const EFFECT_TYPE_FIND_STARTING_CARDS =
  "effects/find_starting_cards";
export declare const EFFECT_TYPE_DRAW_REST_OF_CARDS =
  "effects/draw_rest_of_cards";
export declare const EFFECT_TYPE_DISCARD_CARDS_FROM_HAND =
  "effects/discard_cards_from_hand";
export declare const EFFECT_TYPE_FORBID_ATTACK_TO_CREATURE =
  "effects/forbid_attack_to_creature";
export declare const EFFECT_TYPE_ADD_DELAYED_TRIGGER =
  "effects/add_delayed_trigger";
export declare const EFFECT_TYPE_CREATE_CONTINUOUS_EFFECT =
  "effects/create_continuous_effect";
export declare const EFFECT_TYPE_REARRANGE_ENERGY_ON_CREATURES =
  "effects/rearrange_energy_on_creatures";
export declare const EFFECT_TYPE_DISTRIBUTE_ENERGY_ON_CREATURES =
  "effects/distribute_energy_on_creatures";
export declare const EFFECT_TYPE_DISTRIBUTE_DAMAGE_ON_CREATURES =
  "effects/distribute_damage_on_creatures";
export declare const EFFECT_TYPE_REARRANGE_CARDS_OF_ZONE =
  "effects/rearrange_cards_of_zone";
...
export declare const EXPIRATION_CREATURE_LEAVES_PLAY =
  "expirations/creature_leaves_play";
...
export declare const PROMPT_TYPE_CHOOSE_N_CARDS_FROM_ZONE =
  "prompt/choose_n_cards_from_zone";
export declare const PROMPT_TYPE_CHOOSE_UP_TO_N_CARDS_FROM_ZONE =
  "prompt/choose_up_to_n_cards_from_zone";
export declare const PROMPT_TYPE_ANY_CREATURE_EXCEPT_SOURCE =
  "prompt/any_creature_except_source";
export declare const PROMPT_TYPE_SINGLE_CREATURE_OR_MAGI =
  "prompt/creature_or_magi";
...
export declare const PROMPT_TYPE_SINGLE_CREATURE_FILTERED =
  "prompt/creature_filtered";
export declare const PROMPT_TYPE_NUMBER_OF_CREATURES =
  "prompt/number_of_creatures";
export declare const PROMPT_TYPE_NUMBER_OF_CREATURES_FILTERED =
  "prompt/number_of_creatures_filtered";
...
export declare const PROMPT_TYPE_MAGI_WITHOUT_CREATURES =
  "prompt/magi_without_creatures";
export declare const PROMPT_TYPE_REARRANGE_ENERGY_ON_CREATURES =
  "prompt/rearrange_energy_on_creatures";
export declare const PROMPT_TYPE_DISTRIBUTE_ENERGY_ON_CREATURES =
  "prompt/distribute_energy_on_creatures";
export declare const PROMPT_TYPE_DISTRIBUTE_DAMAGE_ON_CREATURES =
  "prompt/distribute_damage_on_creatures";
export declare const PROMPT_TYPE_PLAYER = "prompt/player";
export declare const PROMPT_TYPE_REARRANGE_CARDS_OF_ZONE =
  "prompt/rearrange_cards_of_zone";
...
export declare const RESTRICTION_ENERGY_LESS_THAN_STARTING =
  "restrictions/energy_less_than_starting";
export declare const RESTRICTION_ENERGY_LESS_THAN =
  "restrictions/energy_less_than";
export declare const RESTRICTION_OWN_CREATURE = "restrictions/own_creature";
export declare const RESTRICTION_OPPONENT_CREATURE =
  "restrictions/opponent_creature";
...
export declare const RESTRICTION_CREATURE_WAS_ATTACKED =
  "restrictions/creature_was_attacked";
export declare const RESTRICTION_MAGI_WITHOUT_CREATURES =
  "restrictions/magi_without_creatures";
...
export declare const LOG_ENTRY_CHOOSES_STARTING_CARDS =
  "log_entry/choose_starting_cards";
export declare const LOG_ENTRY_POWER_ACTIVATION = "log_entry/power_activation";
export declare const LOG_ENTRY_CREATURE_DISCARDED_FROM_PLAY =
  "log_entry/creature_discarded_from_play";
export declare const LOG_ENTRY_RELIC_DISCARDED_FROM_PLAY =
  "log_entry/relic_discarded_from_play";
...
export declare const LOG_ENTRY_CREATURE_ENERGY_LOSS =
  "log_entry/creature_energy_loss";
export declare const LOG_ENTRY_MAGI_ENERGY_LOSS = "log_entry/magi_energy_loss";
export declare const LOG_ENTRY_CREATURE_ENERGY_GAIN =
  "log_entry/creature_energy_gain";

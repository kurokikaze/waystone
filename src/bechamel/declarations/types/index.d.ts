...
export {
  type AttackerDealsDamageEffect,
  type DefenderDealsDamageEffect,
} from "./attack";
export {
  type Region,
  type CardType,
  ...
  type RestrictionObjectType,
} from "./common";
export {
  type SelectType,
  type SelectorTypeType,
  type SelectorParams,
  type RefinedSelectParams,
} from "./select";
...
declare type ProtectionFromType =
  | typeof PROTECTION_FROM_SPELLS
  | typeof PROTECTION_FROM_EFFECTS
  | typeof PROTECTION_FROM_POWERS;
declare type ProtectionTypeType =
  | typeof PROTECTION_TYPE_ENERGY_LOSS
  | typeof PROTECTION_TYPE_ENERGY_GAIN
  | typeof PROTECTION_TYPE_DISCARDING_FROM_PLAY
  | typeof PROTECTION_TYPE_GENERAL;
...
export declare type ReplacementEffectType = {
  ...
  replaceWith:
    | ReplacingEffectType
    | EffectType
    | (ReplacingEffectType | EffectType | PromptType)[];
  mayEffect?: boolean;
  oncePerTurn?: boolean;
};
...
export declare type CalculateType = CalculateParams &
  EnrichedAction & {
...
export declare type PropertyGetterType = EnrichedAction &
...
export declare type AnyEffectType =
  | EffectType
  | PromptType
  | SelectType
  | CalculateType

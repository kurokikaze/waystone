...
export declare type ZoneType =
  ...
  | typeof ZONE_TYPE_ACTIVE_MAGI
  | typeof ZONE_TYPE_DECK
  | typeof ZONE_TYPE_DEFEATED_MAGI
  | typeof ZONE_TYPE_DISCARD
  | typeof ZONE_TYPE_HAND
  | typeof ZONE_TYPE_IN_PLAY;
...
export declare type PropertyType =
  | typeof PROPERTY_MAGI_STARTING_ENERGY
  | typeof PROPERTY_COST
  | typeof PROPERTY_ABLE_TO_ATTACK
  | typeof PROPERTY_ATTACKS_PER_TURN
  | typeof PROPERTY_CAN_ATTACK_MAGI_DIRECTLY
  | typeof PROPERTY_CONTROLLER
  | typeof PROPERTY_CREATURE_TYPES
  | typeof PROPERTY_ENERGIZE
...
export declare type CardType =
  ...
  | typeof TYPE_RELIC
  | typeof TYPE_SPELL;
export declare type PromptTypeType =
  | typeof PROMPT_TYPE_NUMBER
  | typeof PROMPT_TYPE_ANY_CREATURE_EXCEPT_SOURCE
  | typeof PROMPT_TYPE_CHOOSE_CARDS
  | typeof PROMPT_TYPE_CHOOSE_N_CARDS_FROM_ZONE
  | typeof PROMPT_TYPE_NUMBER_OF_CREATURES
  | typeof PROMPT_TYPE_NUMBER_OF_CREATURES_FILTERED
  | typeof PROMPT_TYPE_OWN_SINGLE_CREATURE
  | typeof PROMPT_TYPE_RELIC
  | typeof PROMPT_TYPE_SINGLE_CREATURE
  | typeof PROMPT_TYPE_SINGLE_CREATURE_FILTERED
  | typeof PROMPT_TYPE_SINGLE_CREATURE_OR_MAGI
  | typeof PROMPT_TYPE_MAY_ABILITY
  | typeof PROMPT_TYPE_MAGI_WITHOUT_CREATURES
  | typeof PROMPT_TYPE_SINGLE_MAGI
  | typeof PROMPT_TYPE_REARRANGE_ENERGY_ON_CREATURES
  | typeof PROMPT_TYPE_CHOOSE_UP_TO_N_CARDS_FROM_ZONE
...
export declare type GenericPromptType =
  | typeof PROMPT_TYPE_NUMBER
  | typeof PROMPT_TYPE_ANY_CREATURE_EXCEPT_SOURCE
  | typeof PROMPT_TYPE_CHOOSE_N_CARDS_FROM_ZONE
  | typeof PROMPT_TYPE_NUMBER_OF_CREATURES
...
export declare type ExpirationType =
  | typeof EXPIRATION_OPPONENT_TURNS
...
export declare type RestrictionType =
  | typeof RESTRICTION_CREATURE_WAS_ATTACKED

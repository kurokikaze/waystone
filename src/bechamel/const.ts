...
export const ACTION_CREATE_CONTINOUS_EFFECT =
...
export const PROPERTY_CAN_ATTACK_MAGI_DIRECTLY =
...
export const PROPERTY_ENERGY_LOSS_THRESHOLD =
...
export const PROPERTY_STATUS_DEFEATED_CREATURE =
...
export const SELECTOR_CREATURES_NOT_OF_REGION =
...
export const SELECTOR_OWN_CARDS_WITH_ENERGIZE_RATE =
  "selectors/own_cards_with_energize_rate";
export const SELECTOR_CARDS_WITH_ENERGIZE_RATE =
...
export const SELECTOR_OTHER_CREATURES_OF_TYPE =
...
export const SELECTOR_OWN_CREATURES_WITH_STATUS =
  "selectors/own_creatures_with_status";
export const SELECTOR_CREATURES_WITHOUT_STATUS =
...
export const CALCULATION_SUBTRACT_TO_MINIMUM_OF_ONE =
...
export const PROTECTION_TYPE_DISCARDING_FROM_PLAY =
...
export const EFFECT_TYPE_ATTACKER_DEALS_DAMAGE =
  "effects/attacker_deals_damage";
export const EFFECT_TYPE_DEFENDER_DEALS_DAMAGE =
...
export const EFFECT_TYPE_CREATURE_DEFEATS_CREATURE =
...
export const EFFECT_TYPE_PAYING_ENERGY_FOR_RELIC =
  "effects/paying_energy_for_relic";
export const EFFECT_TYPE_PAYING_ENERGY_FOR_SPELL =
  "effects/paying_energy_for_spell";
export const EFFECT_TYPE_PAYING_ENERGY_FOR_CREATURE =
  "effects/paying_energy_for_creature";
export const EFFECT_TYPE_STARTING_ENERGY_ON_CREATURE =
  "effects/starting_energy_on_creature";
export const EFFECT_TYPE_MOVE_CARD_BETWEEN_ZONES =
  "effects/move_card_between_zones";
export const EFFECT_TYPE_MOVE_CARDS_BETWEEN_ZONES =
  "effects/move_cards_between_zones";
export const EFFECT_TYPE_CARD_MOVED_BETWEEN_ZONES =
  "effects/card_moved_between_zones";
export const EFFECT_TYPE_CONDITIONAL = "effects/conditional";
export const EFFECT_TYPE_ADD_ENERGY_TO_CREATURE_OR_MAGI =
  "effects/add_energy_to_creature_or_magi";
export const EFFECT_TYPE_ADD_ENERGY_TO_CREATURE =
  "effects/add_energy_to_creature";
export const EFFECT_TYPE_ADD_ENERGY_TO_MAGI = "effects/add_energy_to_magi";
export const EFFECT_TYPE_ADD_STARTING_ENERGY_TO_MAGI =
...
export const EFFECT_TYPE_RETURN_CREATURE_DISCARDING_ENERGY =
  "effects/return_creature_discarding_energy";
export const EFFECT_TYPE_RETURN_CREATURE_RETURNING_ENERGY =
  "effects/return_creature_returning_energy";
export const EFFECT_TYPE_DISCARD_ENERGY_FROM_CREATURE =
  "effects/discard_energy_from_creature";
export const EFFECT_TYPE_DISCARD_ENERGY_FROM_CREATURES =
  "effects/discard_energy_from_creatures";
export const EFFECT_TYPE_DISCARD_ENERGY_FROM_MAGI =
  "effects/discard_energy_from_magi";
export const EFFECT_TYPE_DISCARD_CREATURE_FROM_PLAY =
  "effects/discard_creature_from_play";
export const EFFECT_TYPE_DISCARD_CREATURE_OR_RELIC =
  "effects/discard_creature_or_relic";
export const EFFECT_TYPE_DISCARD_ENERGY_FROM_CREATURE_OR_MAGI =
  "effects/discard_energy_from_creature_or_magi";
export const EFFECT_TYPE_RESTORE_CREATURE_TO_STARTING_ENERGY =
  "effects/restore_creature_to_starting_energy";
export const EFFECT_TYPE_PAYING_ENERGY_FOR_POWER =
  "effects/paying_energy_for_power";
export const EFFECT_TYPE_DISCARD_RELIC_FROM_PLAY =
...
export const EFFECT_TYPE_DRAW_CARDS_IN_DRAW_STEP =
...
export const EFFECT_TYPE_DISCARD_CARDS_FROM_HAND =
  "effects/discard_cards_from_hand";
export const EFFECT_TYPE_FORBID_ATTACK_TO_CREATURE =
  "effects/forbid_attack_to_creature";
export const EFFECT_TYPE_ADD_DELAYED_TRIGGER = "effects/add_delayed_trigger";
export const EFFECT_TYPE_CREATE_CONTINUOUS_EFFECT =
  "effects/create_continuous_effect";
export const EFFECT_TYPE_REARRANGE_ENERGY_ON_CREATURES =
  "effects/rearrange_energy_on_creatures";
export const EFFECT_TYPE_DISTRIBUTE_ENERGY_ON_CREATURES =
  "effects/distribute_energy_on_creatures";
export const EFFECT_TYPE_DISTRIBUTE_DAMAGE_ON_CREATURES =
...
export const EXPIRATION_CREATURE_LEAVES_PLAY =
...
export const PROMPT_TYPE_CHOOSE_N_CARDS_FROM_ZONE =
  "prompt/choose_n_cards_from_zone";
export const PROMPT_TYPE_CHOOSE_UP_TO_N_CARDS_FROM_ZONE =
  "prompt/choose_up_to_n_cards_from_zone";
export const PROMPT_TYPE_ANY_CREATURE_EXCEPT_SOURCE =
...
export const PROMPT_TYPE_NUMBER_OF_CREATURES_FILTERED =
...
export const PROMPT_TYPE_MAGI_WITHOUT_CREATURES =
  "prompt/magi_without_creatures";
export const PROMPT_TYPE_REARRANGE_ENERGY_ON_CREATURES =
  "prompt/rearrange_energy_on_creatures";
export const PROMPT_TYPE_DISTRIBUTE_ENERGY_ON_CREATURES =
  "prompt/distribute_energy_on_creatures";
export const PROMPT_TYPE_DISTRIBUTE_DAMAGE_ON_CREATURES =
...
export const RESTRICTION_ENERGY_LESS_THAN_STARTING =
...
export const RESTRICTION_CREATURE_WAS_ATTACKED =
  "restrictions/creature_was_attacked";
export const RESTRICTION_MAGI_WITHOUT_CREATURES =
...
export const LOG_ENTRY_CHOOSES_STARTING_CARDS =
  "log_entry/choose_starting_cards";
export const LOG_ENTRY_POWER_ACTIVATION = "log_entry/power_activation";
export const LOG_ENTRY_CREATURE_DISCARDED_FROM_PLAY =
  "log_entry/creature_discarded_from_play";
export const LOG_ENTRY_RELIC_DISCARDED_FROM_PLAY =

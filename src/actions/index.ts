...
export const START_MAGI_DEFEAT_ANIMATION =
  "actions/start_magi_defeat_animation";
export const END_MAGI_DEFEAT_ANIMATION = "actions/end_magi_defeat_animation";
export const START_CREATURE_DISCARD_ANIMATION =
  "actions/start_creature_discard_animation";
export const END_CREATURE_DISCARD_ANIMATION =
  "actions/end_creature_discard_animation";
export const START_PROMPT_RESOLUTION_ANIMATION =
  "actions/start_prompt_resolution_animation";
export const END_PROMPT_RESOLUTION_ANIMATION =
  "actions/end_prompt_resolution_animation";
...
export const MARK_ENERGY_ANIMATION_AS_DONE =
  "actions/mark_energy_animation_as_done";
...
export const startPowerAnimation = (
  source: string,
  power: any,
  player: number,
) => ({
...
export type StartAttackAnimationAction = ReturnType<
  typeof startAttackAnimation
>;
...
export type StartPromptResolutionAnimationAction = ReturnType<
  typeof startPromptResolutionAnimation
>;
export type EndPromptResolutionAnimationAction = ReturnType<
  typeof endPromptResolutionAnimation
>;
export type StartCreatureAnimationAction = ReturnType<
  typeof startCreatureAnimation
>;
export type StartMagiDefeatAnimationAction = ReturnType<
  typeof startMagiDefeatAnimation
>;
export type StartCreatureDiscardAnimationAction = ReturnType<
  typeof startCreatureDiscardAnimation
>;
export type EndCreatureAnimationAction = ReturnType<
  typeof endCreatureAnimation
>;
...
export type PlusEnergyOnCreatureAction = ReturnType<
  typeof plusEnergyOnCreature
>;
export type MinusEnergyOnCreatureAction = ReturnType<
  typeof minusEnergyOnCreature
>;
export type MarkEnergyAnimationAction = ReturnType<
  typeof markEnergyAnimationDone
>;
